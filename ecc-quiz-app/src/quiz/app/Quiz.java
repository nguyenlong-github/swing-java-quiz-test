...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        question = new JLabel();
        question.setBounds(100, 250, 600, 30);
        ...
        opt1.setBounds(100, 300, 600, 30);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Dialog", Font.PLAIN, 20));
        panel.add(opt1);

        opt2 = new JRadioButton();
        opt2.setBounds(100, 340, 600, 30);
        opt2.setBackground(Color.WHITE);
        opt2.setFont(new Font("Dialog", Font.PLAIN, 20));
        panel.add(opt2);

        opt3 = new JRadioButton();
        opt3.setBounds(100, 380, 600, 30);
        ...
        lifeline.setBounds(320, 500, 200, 30);
        ...
        submit.setBounds(540, 500, 200, 30);
